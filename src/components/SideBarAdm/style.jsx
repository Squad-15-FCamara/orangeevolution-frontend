...
export const HomeLinkStyled = styled(Link)`
  ...
  background-color: ${(props) =>
    props.pathname === '/homeadm' ? '#36357E' : 'white'};
`;

export const TextHome = styled.p`
  color: ${(props) => (props.pathname === '/homeadm' ? 'white' : '#36357E')};
...
export const NotificaLinkStyled = styled(Link)`
  ...
  cursor: pointer;
  background-color: ${(props) =>
    props.pathname === '/profileadm' ? '#36357E' : 'white'};
`;
export const NotificaIcon = styled(FontAwesomeIcon)`
  color: ${(props) => (props.pathname === '/profileadm' ? 'white' : '#36357E')};
  padding-left: 29px;
  font-size: 25px;
`;
