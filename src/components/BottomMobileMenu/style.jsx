...
export const HomeIcon = styled(FontAwesomeIcon)`
  width: 20px;
  color: ${(props) => (props.pathname === '/home' ? '#36357E' : '#929292')};
`;
...
export const BuscaIcon = styled(FontAwesomeIcon)`
  color: ${(props) => (props.pathname === '/search' ? '#36357E' : '#929292')};
`;
export const BuscaText = styled(Text)`
  color: ${(props) => (props.pathname === '/search' ? '#36357E' : '#929292')};
`;

export const SalvoDiv = styled(WrapperLink)``;
export const SalvoIcon = styled(FontAwesomeIcon)`
  color: ${(props) =>
    props.pathname === '/savedcontent' ? '#36357E' : '#929292'};
`;
...
export const ProgressoIcon = styled(FontAwesomeIcon)`
  color: ${(props) => (props.pathname === '/progress' ? '#36357E' : '#929292')};
`;
...
export const PerfilIcon = styled(FontAwesomeIcon)`
  color: ${(props) => (props.pathname === '/profile' ? '#36357E' : '#929292')};
`;
